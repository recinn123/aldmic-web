...
@section('content')
    ...
    <div class="container">
        <div class="text-center mt-5 mb-5">
            ...
            {{-- Logo Partner --}}
            <div class="row row-cols-6 row-cols-md-4 row-cols-lg-6 g-3">
                <div class="col">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3">
                        <div class="col">
                            <div class="text-center">
                                ...
                                <span>We supply and operate our own solution using COOPN Digital's proprietary platform technology and infrastructure</span>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="text-center">
                                ...
                                <span>We provide customized services for our customers by linking to COOPN Digital's exclusive contents</span>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="text-center">
                                ...
                                <span>Providing effective contents targeting each channel customers</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-md-none custom-col mb-5 d-flex justify-content-center align-items-center">
                <div class="row">
                    <div class="row mb-5">
                        <div class="col-6">
                            <div class="text-center">
                                <img src="{{ asset('images/home/property_home_1.png') }}" alt="" class="">
                            </div>
                        </div>
                        <div class="col-6">
